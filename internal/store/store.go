...
type Store interface {
    ...
    LogRequest(ctx context.Context, keyHash, sessionID, variantID, conversationID, contentType, promptSnippet, prompt string, body []byte) error
    LogResponse(ctx context.Context, keyHash, sessionID, variantID, conversationID string, body []byte) error
